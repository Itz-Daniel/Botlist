	...
	run: async(client, message, args) => {
     ...
     .setFooter(client.user.username, client.user.avatarURL())
      ...
      try {
          ...
          return message.channel.send(embed.setDescription("Discord Apide I Could Not Find Such A Bot."));
	  }		
	  ...
	  if(bot) {
        ...
        return message.channel.send(`<a:no:727544475433566330> **${discordBot.username}** Name Bot to the System **${member.username}** Added By Status; **${bot.status}**`)
	 }
